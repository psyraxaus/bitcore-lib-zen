...
BlockHeader._fromObject = function _fromObject(data) {
  ...
  var scTxsCommitment = data.scTxsCommitment;
  ...
  if (_.isString(data.reserved)) {
    scTxsCommitment = BufferUtil.reverse(new Buffer(data.scTxsCommitment, 'hex'));
  }
  ...
  var info = {
    ...
    scTxsCommitment: scTxsCommitment,
    time: data.time,
    timestamp: data.time,
    bits: data.bits,
    nonce: nonce,
...
BlockHeader.prototype.toObject = BlockHeader.prototype.toJSON = function toObject() {
  return {
    ...
    scTxsCommitment: BufferUtil.reverse(this.scTxsCommitment).toString('hex'),
    time: this.time,
    bits: this.bits,
