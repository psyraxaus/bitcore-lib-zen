...
/**
 * Return the output in a standard transaction format
 */
SidechainCertificateOutput.prototype.getTxOutput = function() {
  var s = new Script();
  s.add(Opcode.OP_DUP)
      .add(Opcode.OP_HASH160)
      .add(this._pubKeyHash)
  ...
  var output = new Output(obj);
  output.isFromBackwardTransfer = true;
  return output;
};
