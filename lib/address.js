...
function Address(data, network, type) {
  ...
  if (type && (type !== Address.PayToPublicKeyHash && type !== Address.PayToScriptHash && type !== Address.PayToPublicKeyHashReplay)) {
...
/** @static */
Address.PayToPublicKeyHashReplay = 'pubkeyhashreplay';
/** @static */
...
Address._transformObject = function(data) {
  ...
  return {
    ...
    type: data.type == Address.PayToPublicKeyHashReplay ? Address.PayToPublicKeyHash : data.type
  };
};
...
/**
 * Returns true if an address is of pay to public key hash reply type
 * @return boolean
 */
Address.prototype.isPayToPublicKeyHashReplay = function() {
  return this.type === Address.PayToPublicKeyHashReplay;
};
...
Address.prototype.isScriptHash = function() {
  return this.type === Address.ScriptHash;
};
