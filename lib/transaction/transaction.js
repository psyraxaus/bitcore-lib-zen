...
Transaction.prototype.toBufferWriter = function(writer) {
  ...
  if (this.version == -5) {
    ...
    writer.write(Buffer.from(this.scProof, 'hex'));
  }
...
Transaction.prototype.fromBufferReader = function(reader) {
  ...
  if (this.version == -5) {
    ...
    this.endEpochBlockHash = BufferUtil.reverse(reader.read(32)).toString('hex');
    this.scProof = reader.read(771).toString('hex');
  }
...
Transaction.prototype.toObject = Transaction.prototype.toJSON = function toObject() {
  ...
  if (this.version == -5) {
    ...
    obj.endEpochBlockHash = this.endEpochBlockHash;
...
Transaction.prototype.fromObject = function fromObject(arg) {
  ...
  if (this.version == -5){
    ...
    this.endEpochBlockHash = transaction.endEpochBlockHash;
    this.scProof = transaction.scProof;
    var amn = this._checkAmount(transaction.quality);
    this.quality = amn.amount;
    this.qualityBN = amn.amountBN;
  }else {
    if (this.version == -4){
          var obj ={
